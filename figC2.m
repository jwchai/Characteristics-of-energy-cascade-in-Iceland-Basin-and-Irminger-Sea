clc;clear; close all;
load('./data/energyflux_irm_spring_LS.mat')
load('./data/corase_irminger_spring.mat');
...
text(1.5,-5e-8,'Irminger Sea','FontSize',16,'Color',[.5,.5,.5],'BackgroundColor', 'w')
...
%%
clear
load('./data/energyflux_irm_summer_LS.mat');
load('./data/corase_irminger_summer.mat');
...
%%
clear
load('./data/energyflux_irm_fall_LS.mat');
load('./data/corase_irminger_fall.mat');
ax = nexttile(3)
h1 = plot((1./energyflux.kf)/1e3, energyflux.mean_SpecFlux(1:end),'Color',[0.00,0.4471,0.698],'LineWidth',3)
hold on
xlog
